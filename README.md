##ATENÇÃO: NÃO fui eu que desenvolvi este projeto. Este é um material de uma palestra que particiei. Não foi possível eu fazer as implementações que foram requisitadas.
